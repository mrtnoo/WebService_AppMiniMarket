    ...
    public partial class FrmCategoria : Form
    {
        ...
        private void Listar()
        {
            try
            {
                ...
                DgvListado.DataSource = cat.WebListar().Tables[0];
                this.Limpiar();
                LblTotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
                //NCategoria cat = new NCategoria();
                //DgvListado.DataSource = cat.Listar();
                //this.Formato();
                //this.Limpiar();
                //LblTotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
            }
        ...
        private void Buscar()
        {
            try
            {
                //NCategoria cat = new NCategoria();
                ServiceCategoria.WebServiceCategoriaSoapClient cat = new ServiceCategoria.WebServiceCategoriaSoapClient();
                DataTable dt = cat.WebBuscar(TxtBuscar.Text).Tables[0];
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    //NCategoria cat = new NCategoria();
                    ServiceCategoria.WebServiceCategoriaSoapClient cat = new ServiceCategoria.WebServiceCategoriaSoapClient();
                    Rpta = cat.WebInsertar(TxtNombre.Text.Trim(), TxtDescripcion.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    //NCategoria cat = new NCategoria();
                    ServiceCategoria.WebServiceCategoriaSoapClient cat = new ServiceCategoria.WebServiceCategoriaSoapClient();
                    Rpta = cat.WebActualizar(Convert.ToInt32(TxtId.Text), this.NombreAnt, TxtNombre.Text.Trim(), TxtDescripcion.Text.Trim());
                    if (Rpta.Equals("OK"))
                    {
