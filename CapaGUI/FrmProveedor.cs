    ...
    public partial class FrmProveedor : Form
    {
        ...
        private void Listar()
        {
            try
            {
                ...
                DataTable dt = persona.WebListarProveedores().Tables[0];
        ...
        private void Buscar()
        {
            ...
            {
                ServicePersona.WebServicePersonaSoapClient persona = new ServicePersona.WebServicePersonaSoapClient();
                DataTable dt = persona.WebBuscarProveedores(TxtBuscar.Text).Tables[0];
                DgvListado.DataSource = dt;
                this.Formato();
                LblTotal.Text = "Total registros: " + Convert.ToString(DgvListado.Rows.Count);
            }
        ...
        private void BtnInsertar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ServicePersona.WebServicePersonaSoapClient persona = new ServicePersona.WebServicePersonaSoapClient();
                    Rpta = persona.WebInsertar("Proveedor", TxtNombre.Text.Trim(), CboTipoDoc.Text, TxtNumDoc.Text.Trim(),
        ...
        private void BtnActualizar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ServicePersona.WebServicePersonaSoapClient persona = new ServicePersona.WebServicePersonaSoapClient();
                    Rpta = persona.WebActualizar(Convert.ToInt32(TxtId.Text), "Proveedor", this.NombreAnt, TxtNombre.Text.Trim(), CboTipoDoc.Text, TxtNumDoc.Text.Trim(),
                                             TxtDireccion.Text.Trim(), TxtTelefono.Text.Trim(), TxtEmail.Text.Trim());
