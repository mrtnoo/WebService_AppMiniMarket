    ...
    public class CProducto
    {
        public DataSet Listar()
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("producto_listar", SqlCon);
        ...
        public DataSet BuscarCodigo(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("producto_buscar_codigo", SqlCon);
                SqlDataAdapter adap = new SqlDataAdapter();
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@valor", SqlDbType.VarChar).Value = Valor;
                SqlCon.Open();
        ...
        public DataSet BuscarCodigoVenta(string Valor)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("producto_buscar_codigo_venta", SqlCon);
                SqlDataAdapter adap = new SqlDataAdapter();
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@valor", SqlDbType.VarChar).Value = Valor;
                SqlCon.Open();
        ...
        public string Actualizar(Producto Obj)
        {
            ...
            {
                SqlCon = Conexion.getInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("producto_actualizar", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
